(function () {
	...
	let Person = defineClass();

	let grandDad = new Person();
	let grandMom = new Person();

	let RoundBread = defineClass();
	...
	let kolobok = grandDad.ask(grandMom).bakeBread();
	...
	RoundBread.prototype.roll = function (done) {
		...
		let that = this;
		let places = ['on the bench', 'on the floor', 'at the door', 'on the yard', 'far-far away'];
	...
	RoundBread.prototype.sing = function () {
		let acquaintances = this.acquaintances.slice();
